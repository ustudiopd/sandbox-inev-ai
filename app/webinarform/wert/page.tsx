        ...
        <div className="w-full px-4 sm:px-6 lg:px-[72px] pt-[72px] sm:pt-16 lg:pt-[315px] pb-6 sm:pb-8 lg:pb-20 relative inline-flex flex-col justify-start items-center gap-4 sm:gap-8 lg:gap-20 z-10">
          <div className="self-stretch flex flex-col justify-start items-center gap-4 sm:gap-8 lg:gap-16">
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-2 sm:gap-4 lg:gap-8">
              <div className="self-stretch text-center justify-start text-black font-bold text-xs sm:text-base lg:text-[36px] leading-relaxed sm:leading-relaxed lg:leading-[60px]" style={{ fontFamily: 'Pretendard, sans-serif' }}>
          ...
          <div className="w-full max-w-[384px] flex flex-col justify-start items-start gap-2.5 sm:gap-4 lg:gap-8">
            <Link
              href="/event/149403/register"
              className="self-stretch px-4 sm:px-8 lg:pl-16 lg:pr-10 py-2.5 sm:py-3 lg:py-6 bg-[#00A08C] rounded-full lg:rounded-[200px] inline-flex justify-center items-center gap-2 sm:gap-3 lg:gap-6 overflow-hidden min-h-[44px] sm:min-h-[48px]"
            >
        ...
        <div className="w-full max-w-[858px] mx-auto px-4 sm:px-6 lg:px-[72px] flex flex-col justify-start items-start gap-8 sm:gap-12 lg:gap-20">
          <div className="self-stretch flex flex-col justify-start items-center gap-3.5">
            ...
            <div className="self-stretch flex flex-col justify-start items-center gap-4 sm:gap-6 lg:gap-12">
              ...
              <div className="self-stretch text-center justify-start text-xs sm:text-base lg:text-[36px] leading-relaxed sm:leading-relaxed lg:leading-[60px]">
          ...
          <div className="self-stretch flex flex-col justify-start items-center gap-6 sm:gap-10 lg:gap-16">
            <div className="self-stretch flex flex-col justify-start items-center gap-2 sm:gap-3">
              <div className="self-stretch text-center justify-start text-teal-600 font-bold text-xs sm:text-base lg:text-[24px] leading-tight sm:leading-tight lg:leading-[40px]" style={{ fontFamily: 'Figtree, sans-serif' }}>
                IN THE WEBINAR
              </div>
              <div className="self-stretch text-center justify-start text-black/80 font-bold text-lg sm:text-xl lg:text-[38px] leading-tight sm:leading-tight lg:leading-[57px]" style={{ fontFamily: 'Pretendard, sans-serif' }}>
                이번 웨비나에서는
              </div>
            </div>
      ...
      <section className="w-full relative bg-gradient-to-b from-emerald-900 to-black overflow-hidden py-8 sm:py-12 lg:py-20">
        ...
        <div className="w-full max-w-[856px] mx-auto px-4 sm:px-6 lg:px-[72px] flex flex-col justify-start items-start gap-6 sm:gap-10 lg:gap-16">
          ...
          <div className="self-stretch lg:hidden pl-3 sm:pl-5 pr-3 sm:pr-6 py-3 sm:py-4 bg-white/10 rounded-lg sm:rounded-xl outline outline-1 outline-offset-[-1px] outline-white/20 flex flex-row justify-start items-center gap-2 sm:gap-3 overflow-hidden">
            <div className="text-white font-bold text-xs sm:text-sm leading-tight whitespace-nowrap flex-shrink-0" style={{ fontFamily: 'Pretendard, sans-serif' }}>
              일시
            </div>
          ...
          {/* 모바일용 장소, 참가비 */}
          <div className="self-stretch sm:hidden flex flex-col justify-start items-start gap-2.5">
            <div className="self-stretch pl-3 pr-3 py-3 bg-white/10 rounded-lg outline outline-1 outline-offset-[-1px] outline-white/20 flex flex-row justify-start items-center gap-2 overflow-hidden">
              <div className="text-white font-bold text-xs leading-tight whitespace-nowrap flex-shrink-0" style={{ fontFamily: 'Pretendard, sans-serif' }}>
                장소
              </div>
          ...
          <div className="hidden sm:flex lg:hidden self-stretch pl-5 pr-6 py-4 bg-white/10 rounded-xl outline outline-1 outline-offset-[-1px] outline-white/20 flex flex-row justify-start items-center gap-3 overflow-hidden">
            <div className="text-white font-bold text-sm leading-tight whitespace-nowrap flex-shrink-0" style={{ fontFamily: 'Pretendard, sans-serif' }}>
              장소
            </div>
        ...
        <div className="w-full max-w-[856px] mx-auto px-4 sm:px-6 lg:px-[72px] mt-6 sm:mt-10 lg:mt-20 flex flex-col justify-start items-start gap-8 sm:gap-12 lg:gap-16">
          <div className="self-stretch flex flex-col justify-start items-center gap-2 sm:gap-3">
            <div className="self-stretch text-center justify-start text-green-200 font-bold text-base sm:text-lg lg:text-[24px] leading-tight sm:leading-tight lg:leading-[32px]" style={{ fontFamily: 'Figtree, sans-serif' }}>
              AGENDA & SPEAKER
            </div>
            <div className="self-stretch text-center justify-start text-white font-bold text-lg sm:text-xl lg:text-[38px]" style={{ fontFamily: 'Pretendard, sans-serif' }}>
              세션 소개 및 발표연사
            </div>
          </div>
            ...
            {sessions.map((session, index) => (
              ...
              >
                <div className="self-stretch flex flex-col justify-start items-start gap-6 sm:gap-8 lg:gap-10">
                  ...
                  <div className="self-stretch flex flex-col justify-start items-start gap-6 sm:gap-8 lg:gap-10">
                    ...
                    <div className="self-stretch flex flex-col justify-start items-start gap-4 sm:gap-5 lg:gap-6">
                      ...
                      {session.note && (
                        <div className="self-stretch inline-flex justify-start items-center gap-2 sm:gap-4 -mt-2">
                ...
                {session.speaker && (
                  <>
                    <div className="self-stretch h-px bg-white/20"></div>
                    <div className="inline-flex flex-col sm:flex-row justify-start items-start sm:items-center gap-4 sm:gap-8 lg:gap-12">
                      <div className="w-32 h-28 sm:w-40 sm:h-36 lg:w-56 lg:h-48 relative flex-shrink-0">
                        <Image
          ...
          <div className="self-stretch p-4 sm:p-8 lg:p-16 bg-stone-50 rounded-2xl sm:rounded-3xl lg:rounded-[48px] shadow-[0px_4px_48px_-10px_rgba(0,0,0,0.08)] flex flex-col justify-start items-start gap-8 sm:gap-12 lg:gap-16 overflow-hidden">
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-3 sm:gap-4 lg:gap-6">
              <div className="self-stretch inline-flex flex-col sm:flex-row justify-between items-start sm:items-center gap-2 sm:gap-0">
                <div className="text-center sm:text-left justify-start text-black/80 font-semibold text-base sm:text-xl lg:text-[36px]" style={{ fontFamily: 'Pretendard, sans-serif' }}>
                  특허 문헌
                </div>
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-6 sm:gap-8 lg:gap-10">
              <div className="self-stretch flex flex-col justify-center items-center gap-6 sm:gap-8 lg:gap-10">
                ...
                <div className="self-stretch flex flex-col justify-start items-center gap-4 sm:gap-5 lg:gap-6">
                  <div className="justify-start text-white font-bold text-2xl sm:text-3xl lg:text-[48px] leading-tight sm:leading-tight lg:leading-[40px]" style={{ fontFamily: 'Pretendard, sans-serif' }}>
                    QnA 이벤트
                  </div>
                  <div className="text-center justify-start">
                    ...
                    <span className="text-white font-normal text-base sm:text-xl lg:text-[30px] leading-relaxed sm:leading-relaxed lg:leading-[48px]" style={{ fontFamily: 'Pretendard, sans-serif' }}>
                      {" "}추첨을 통해<span className="sm:hidden"> </span><span className="hidden sm:inline"><br /></span>선물을 드립니다.
                    </span>
                  </div>
                </div>
              </div>
              <div className="self-stretch min-h-[180px] sm:h-44 lg:h-56 p-4 sm:p-6 lg:p-10 bg-black/10 rounded-xl sm:rounded-2xl lg:rounded-[32px] outline outline-1 outline-offset-[-1px] outline-white/20 flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-4 lg:gap-2.5 overflow-hidden">
                <div className="flex-1 justify-start text-white font-bold text-lg sm:text-xl lg:text-[36px] leading-relaxed sm:leading-relaxed lg:leading-[60px] text-center sm:text-left" style={{ fontFamily: 'Pretendard, sans-serif' }}>
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-6 sm:gap-8 lg:gap-10">
              <div className="self-stretch flex flex-col justify-center items-center gap-6 sm:gap-8 lg:gap-10">
                ...
                <div className="self-stretch flex flex-col justify-center items-center gap-4 sm:gap-5 lg:gap-6">
                  <div className="text-center justify-start text-neutral-100 font-bold text-2xl sm:text-3xl lg:text-[48px] leading-tight sm:leading-tight lg:leading-[40px]" style={{ fontFamily: 'Pretendard, sans-serif' }}>
                    특별 혜택 이벤트
                  </div>
                  <div className="text-center justify-start">
                    <span className="text-white font-normal text-base sm:text-xl lg:text-[30px] leading-relaxed sm:leading-relaxed lg:leading-[48px]" style={{ fontFamily: 'Pretendard, sans-serif' }}>
              ...
              <div className="self-stretch flex flex-col justify-start items-start gap-8 sm:gap-10 lg:gap-12 relative">
                ...
                <div className="self-stretch min-h-[160px] sm:h-40 lg:h-56 p-4 sm:p-6 lg:p-10 bg-gradient-to-r from-black/5 to-black/10 rounded-xl sm:rounded-2xl lg:rounded-[32px] outline outline-1 outline-offset-[-1px] outline-white/20 flex flex-col sm:flex-row justify-between items-center gap-2.5 sm:gap-3 lg:gap-2.5 overflow-hidden">
                  <div className="flex-1 justify-start text-center sm:text-left">
                    <span className="text-white font-normal text-base sm:text-lg lg:text-[36px] leading-relaxed sm:leading-relaxed lg:leading-[60px]" style={{ fontFamily: 'Pretendard, sans-serif' }}>
                      키워트 인사이트 신규회원 대상<br />
                    </span>
                    <span className="text-white font-bold text-base sm:text-lg lg:text-[36px] leading-relaxed sm:leading-relaxed lg:leading-[60px]" style={{ fontFamily: 'Pretendard, sans-serif' }}>
                      1달 무료 체험 제공
                    </span>
                  </div>
                  <img
                ...
                {/* 특별 견적 */}
                <div className="self-stretch min-h-[160px] sm:h-40 lg:h-56 p-4 sm:p-6 lg:p-10 bg-black/10 rounded-xl sm:rounded-2xl lg:rounded-[32px] outline outline-1 outline-offset-[-1px] outline-white/20 flex flex-col sm:flex-row justify-between items-center gap-2.5 sm:gap-3 lg:gap-2.5 overflow-hidden">
                  <div className="flex-1 justify-start text-center sm:text-left">
                    <span className="text-white font-normal text-base sm:text-lg lg:text-[36px] leading-relaxed sm:leading-relaxed lg:leading-[60px]" style={{ fontFamily: 'Pretendard, sans-serif' }}>
                      웨비나 참여 후 엔터프라이즈용<br />
                    </span>
          ...
          <div className="self-stretch flex flex-col justify-start items-start gap-4 sm:gap-6 lg:gap-8">
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-4">
              ...
              <div className="self-stretch inline-flex justify-start items-start gap-2">
                ...
                <div className="flex-1 justify-start text-black/60 font-normal text-sm sm:text-base lg:text-[27px] leading-relaxed sm:leading-relaxed lg:leading-[40px]" style={{ fontFamily: 'Pretendard, sans-serif', letterSpacing: '-0.4px' }}>
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-4">
              <div className="self-stretch inline-flex justify-start items-start gap-2 sm:gap-3">
                ...
                <div className="flex-1 justify-start text-orange-600 font-normal text-sm sm:text-base lg:text-[27px] leading-relaxed sm:leading-relaxed lg:leading-[40px]" style={{ fontFamily: 'Pretendard, sans-serif', letterSpacing: '-0.4px' }}>
                  본 웨비나는 라이브로 진행되며 녹화본은 별도 제공하지 않습니다.
                </div>
              </div>
              <div className="self-stretch inline-flex justify-start items-start gap-2 sm:gap-3">
                <div className="w-5 h-5 sm:w-6 sm:h-6 flex-shrink-0 flex items-start pt-1 sm:pt-2">
                  <img
                    src="https://yqsayphssjznthrxpgfb.supabase.co/storage/v1/object/public/webinar-thumbnails/wert/notice.png"
                    alt="주의"
                    className="w-full h-full object-contain"
        ...
        <div className="self-stretch flex flex-col justify-start items-start gap-6 sm:gap-8 lg:gap-10">
          ...
          <div className="self-stretch flex flex-col justify-start items-start gap-3 sm:gap-4">
            <div className="self-stretch inline-flex justify-start items-center gap-2">
              <div className="w-5 flex-shrink-0 relative">
                <div className="w-2 h-2 left-0 top-1/2 -translate-y-1/2 absolute bg-black/60 rounded-full"></div>
              </div>
              <div className="flex-1 justify-start text-black/60 font-normal text-sm sm:text-base lg:text-[27px] leading-relaxed sm:leading-relaxed lg:leading-[40px]" style={{ fontFamily: 'Pretendard, sans-serif', letterSpacing: '-0.4px' }}>
