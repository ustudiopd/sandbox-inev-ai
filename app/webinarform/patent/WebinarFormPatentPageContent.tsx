...
const organizationCards = [
  {
    ...
    image: `${WERT_IMAGE_BASE}/image 51.png`,
  ...
  },
  {
    ...
    image: `${WERT_IMAGE_BASE}/image 52.png`,
  ...
  },
  {
    ...
    image: `${WERT_IMAGE_BASE}/image 50.png`,
    ...
    <div className="bg-white min-h-screen overflow-x-hidden">
      ...
      <section 
        ...
        style={{ 
          ...
          width: '100vw',
          backgroundImage: `url(${WERT_IMAGE_BASE}/bg2.png)`,
          ...
          <div className="self-stretch flex flex-col justify-start items-center gap-4 sm:gap-8 lg:gap-16">
            <div className="w-full max-w-[623px] flex flex-col justify-start items-center gap-3 sm:gap-5 lg:gap-10">
              ...
              <div className="flex justify-center items-center" style={{ marginTop: '24px', marginBottom: '24px' }}>
                <Image
                  src={`${WERT_IMAGE_BASE}/ip_insight_on.png`}
                  alt="IP Insight ON"
                  width={204}
                  height={60}
            ...
            <div className="w-full flex flex-col justify-start items-start gap-3 sm:gap-8 lg:gap-10">
              ...
              <div className="w-full px-4 sm:px-0 h-[128px] sm:h-44 lg:h-56 p-4 sm:p-6 lg:p-10 bg-black/10 rounded-xl sm:rounded-2xl lg:rounded-[32px] outline outline-1 outline-offset-[-1px] outline-white/20 flex flex-row justify-start items-center gap-3 sm:gap-4 lg:gap-2.5 overflow-hidden">
                ...
                <img
                  ...
                  src={`${WERT_IMAGE_BASE}/image_2.png`}
                  alt="스타벅스 커피"
                />
              </div>
            </div>
            ...
            <div className="w-full flex flex-col justify-start items-start gap-6 sm:gap-8 lg:gap-10">
              ...
              <div className="w-full px-4 sm:px-0 flex flex-col justify-start items-start gap-3 sm:gap-5 lg:gap-6 relative">
                ...
                <div className="hidden sm:block lg:hidden absolute left-1/2 -translate-x-1/2 -translate-y-1/2 z-10" style={{ top: 'calc(120px + 0.625rem)' }}>
                  <img
                    src={`${WERT_IMAGE_BASE}/icon_plus.png`}
                    alt="plus"
              ...
              <div className="self-stretch inline-flex justify-start items-start gap-1.5 sm:gap-3">
                <div className="w-3 sm:w-6 flex-shrink-0 relative">
                  <div className="absolute top-[9px] left-0 sm:top-[2px] lg:top-[8px]">
                    <img
                      src={`${WERT_IMAGE_BASE}/notice.png`}
                      alt="주의"
      ...
      >
        <img
          src={`${WERT_IMAGE_BASE}/kewert_logo-w.png`}
