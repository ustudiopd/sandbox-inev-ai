...
import EventTodayMenuPage from './EventTodayMenuPage'
...
export default async function EventMenuRoute({ params }: Props) {
  ...
  if (isLocalhost(host) && slug === '222152') {
    ...
    return <EventTodayMenuPage event={mockEvent} pathSlug={slug} />
  }
  ...
  return <EventTodayMenuPage event={event} pathSlug={slug} />
}
