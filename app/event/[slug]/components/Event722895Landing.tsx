...
export default function Event722895Landing({ event }: Event722895LandingProps) {
  ...
  return (
    <>
      {/* ===== 히어로 섹션 ===== */}
      <div className="w-full h-[300px] md:h-[754px] relative overflow-hidden bg-cover bg-center bg-no-repeat" style={{ backgroundImage: `url(${heroBgImageUrl})` }}>
        <div className="w-full max-w-[1000px] mx-auto h-full relative px-5 md:px-0">
        </div>
      </div>

      {/* ===== "이번 웨비나에서는" 섹션 ===== */}
      <div className="w-full bg-slate-100">
        <div className="w-full max-w-[1000px] mx-auto md:h-[1178px] relative overflow-hidden px-5 md:px-0 py-10 md:py-0">
      ...
      {/* ===== "이런 분들께 추천합니다" 섹션 ===== */}
      <div className="w-full md:h-[1812px] relative bg-gradient-to-b from-slate-200 to-stone-50 overflow-hidden">
        <div className="w-full max-w-[1000px] mx-auto h-full relative px-5 md:px-0 pt-10 pb-0 md:py-0">
      ...
      {/* ===== 프로그램/행사 정보 섹션 ===== */}
      <div className="w-full md:h-[3140px] relative bg-gray-700 overflow-hidden">
        <div className="w-full max-w-[1000px] mx-auto h-full relative px-5 md:px-0 py-10 md:py-0">
        {/* 섹션 타이틀 */}
          ...
          <div className="self-stretch px-4 md:px-6 py-2 md:py-3 bg-gradient-to-r from-lime-300 to-cyan-400 rounded-xl md:rounded-2xl flex flex-col justify-start items-start gap-2 md:gap-2.5 overflow-hidden">
            <div className="self-stretch inline-flex justify-between items-center">
              <div className="flex-1 md:w-96 flex justify-start items-center gap-1.5 md:gap-2">
                <div className="w-5 h-5 md:w-7 md:h-7 bg-black rounded-full" />
                <div className="w-2 h-4 md:w-2.5 md:h-6 text-center justify-start text-lime-300 text-sm md:text-xl font-bold font-['Pretendard']">1</div>
        ...
        <div className="w-full md:w-[856px] md:left-[72px] md:top-[658px] md:absolute inline-flex flex-col justify-start items-start gap-6 md:gap-12">
          <div className="self-stretch px-4 md:px-6 py-2 md:py-3 bg-gradient-to-r from-lime-300 to-cyan-400 rounded-xl md:rounded-2xl flex flex-col justify-start items-start gap-2 md:gap-2.5 overflow-hidden">
            <div className="self-stretch inline-flex justify-between items-center">
              <div className="flex-1 md:w-96 flex justify-start items-center gap-1.5 md:gap-2">
                <div className="w-5 h-5 md:w-7 md:h-7 bg-black rounded-full" />
                <div className="w-2 h-4 md:w-2.5 md:h-6 text-center justify-start text-lime-300 text-sm md:text-xl font-bold font-['Pretendard']">2</div>
          ...
          <div className="self-stretch flex flex-col justify-start items-start gap-2">
            ...
            <div className="self-stretch md:h-36 relative bg-black/25 rounded-xl md:rounded-2xl overflow-hidden p-4 md:p-0">
              <div className="md:left-[40px] md:top-[40px] md:absolute inline-flex flex-col md:flex-row justify-start items-start md:items-center gap-3 md:gap-8">
                <div className="px-3 md:px-4 py-1 md:py-1.5 bg-white/10 rounded-full md:rounded-[41px] outline outline-1 outline-offset-[-1px] outline-lime-300 flex justify-center items-center gap-2 md:gap-2.5 overflow-hidden">
            ...
            <div className="self-stretch md:h-[603px] relative bg-black/25 rounded-xl md:rounded-2xl overflow-hidden p-4 md:p-0">
              <div className="md:w-[775px] md:left-[40px] md:top-[40px] md:absolute inline-flex flex-col justify-start items-start gap-4 md:gap-6">
                ...
                <div className="self-stretch flex flex-col gap-1 md:gap-2 pl-0 md:pl-[208px]">
      ...
      {/* ===== 이벤트 섹션 ===== */}
      <div className="w-full md:h-[2856px] relative bg-slate-200 overflow-hidden">
        <div className="w-full max-w-[1000px] mx-auto h-full relative px-5 md:px-0 py-10 md:py-0">
        {/* 로고 */}
        ...
        {/* 선물 아이콘 - 데스크톱만 */}
        <div className="hidden md:block h-28 px-9 py-3.5 absolute bg-white/5 rounded-[37.91px] inline-flex justify-center items-center gap-3 overflow-hidden" style={{ left: '690px', top: '147px' }}>
          <img 
        ...
        <div className="md:w-[856px] md:h-64 md:left-[72px] md:top-[1493px] md:absolute bg-stone-600 rounded-[20px] md:rounded-[32px] overflow-hidden relative p-4 md:p-0 mb-4 md:mb-0 min-h-[100px] md:min-h-0 flex md:block">
          <div className="md:left-[40px] md:top-[56px] md:absolute inline-flex flex-col justify-start items-start gap-1.5 md:gap-3 pr-0 md:pr-0">
        ...
        <div className="md:w-[856px] md:h-72 md:left-[72px] md:top-[1760px] md:absolute bg-amber-800 rounded-[20px] md:rounded-[32px] overflow-hidden relative p-4 md:p-0 mb-6 md:mb-0 min-h-[120px] md:min-h-0 flex md:block">
          ...
          <div className="hidden md:block md:w-[733px] md:left-[40px] md:top-[211px] md:absolute justify-start text-white/60 text-2xl font-normal font-['Pretendard'] leading-9">*설문조사는 웨비나 종료 후 작성 가능합니다.</div>
        ...
        <div className="md:w-[856px] md:left-[72px] md:top-[2163px] md:absolute inline-flex flex-col justify-start items-start gap-6 md:gap-10">
          ...
          <div className="self-stretch flex flex-row justify-start items-stretch gap-3 md:gap-4">
            <div className="flex-1 h-[120px] md:h-auto p-3 md:p-10 bg-gray-700 rounded-[20px] md:rounded-[32px] outline outline-1 outline-offset-[-1px] outline-white/20 inline-flex flex-col justify-start items-end gap-2 md:gap-10 overflow-hidden">
              <div className="self-stretch justify-start">
                <span className="text-white text-xs md:text-3xl font-bold font-['Pretendard'] leading-4 md:leading-10">키워트 인사이트 신규회원 대상 </span>
                <span className="text-teal-400 text-xs md:text-3xl font-bold font-['Pretendard'] leading-4 md:leading-10">무료 체험 제공</span>
              </div>
              <img className="w-12 h-12 md:w-32 md:h-32 object-contain -mt-2 md:mt-0" src="https://gbkivxdlebdtfudexbga.supabase.co/storage/v1/object/public/webinar-thumbnails/wert/0312_icon_7.png" alt="Benefit" />
            </div>
            <div className="flex-1 h-[120px] md:h-auto p-3 md:p-10 bg-gray-700 rounded-[20px] md:rounded-[32px] outline outline-1 outline-offset-[-1px] outline-white/20 inline-flex flex-col justify-start items-end gap-2 md:gap-10 overflow-hidden">
              <div className="self-stretch justify-start">
                <span className="text-white text-xs md:text-3xl font-bold font-['Pretendard'] leading-4 md:leading-10">웨비나 참여 후 엔터프라이즈용 상담 신청하면 </span>
                <span className="text-teal-400 text-xs md:text-3xl font-bold font-['Pretendard'] leading-4 md:leading-10">특별 견적 제공</span>
              </div>
              <img className="w-12 h-12 md:w-32 md:h-32 object-contain -mt-2 md:mt-0" src="https://gbkivxdlebdtfudexbga.supabase.co/storage/v1/object/public/webinar-thumbnails/wert/0312_icon_8.png" alt="Benefit" />
            </div>
          </div>
        </div>
        </div>
      ...
      {/* ===== 주의사항/문의사항 섹션 ===== */}
      <div className="w-full px-5 md:px-16 py-12 md:py-28 bg-neutral-50 flex flex-col justify-start items-start gap-8 md:gap-16 overflow-hidden">
