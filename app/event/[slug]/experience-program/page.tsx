...
import EventExperienceProgramPage from './EventExperienceProgramPage'
...
export default async function EventExperienceProgramRoute({ params }: Props) {
  ...
  if (isLocalhost(host) && slug === '222152') {
    ...
    return <EventExperienceProgramPage event={mockEvent} pathSlug={slug} />
  }
  ...
  return <EventExperienceProgramPage event={event} pathSlug={slug} />
}
