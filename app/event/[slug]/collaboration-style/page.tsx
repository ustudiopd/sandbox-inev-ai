...
import CollaborationStylePage from './CollaborationStylePage'
...
export default async function CollaborationStyleRoute({ params }: Props) {
  ...
  if (isLocalhost(host) && slug === '222152') {
    ...
    return <CollaborationStylePage event={mockEvent} pathSlug={slug} />
  }
  ...
  return <CollaborationStylePage event={event} pathSlug={slug} />
}
