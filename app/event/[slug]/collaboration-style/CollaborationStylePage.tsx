        ...
        <main className="w-full flex justify-center items-center box-border flex-1 px-4 sm:px-6 md:px-8 lg:px-16 xl:px-[250px] py-12 sm:py-24 md:py-[150px] pb-12 md:pb-[145px] overflow-x-hidden">
          <div className="flex flex-col md:flex-row items-center w-full max-w-full gap-8 md:gap-[77px] md:ml-[350px]">
            <div className="relative flex-shrink-0 w-full max-w-[278px] mx-auto md:mx-0 md:w-[278px] md:max-w-none">
              {/* 모바일 전용 꾸밈 (md에서 숨김) */}
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 61" fill="none" className="absolute md:hidden w-10 h-auto left-5 -top-[100px] z-10" aria-hidden>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 110 107" fill="none" className="absolute md:hidden w-9 h-auto -left-10 top-8 z-10" aria-hidden>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 130 139" fill="none" className="absolute md:hidden w-10 h-auto left-0 top-[258px] z-10" aria-hidden>
            ...
            <div className="relative flex flex-col justify-center items-start flex-1 min-w-0 w-full max-w-full md:min-w-[280px] md:max-w-[437px] px-2 md:px-0 md:pt-[18px]">
              {/* 모바일 전용 꾸밈 */}
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 132 135" fill="none" className="absolute md:hidden w-10 h-auto right-0 -top-[350px] z-10" aria-hidden>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 124 69" fill="none" className="absolute md:hidden w-9 h-auto right-0 -top-1 z-10" aria-hidden>
            ...
            <div className="relative inline-block mt-8 md:mt-10">
              ...
              {/* 모바일 전용 꾸밈 */}
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 111 83" fill="none" className="absolute md:hidden w-8 h-auto left-full top-4 ml-[68px] z-10" aria-hidden>
