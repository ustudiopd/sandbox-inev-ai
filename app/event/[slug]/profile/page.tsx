...
export default async function EventProfileRoute({ params }: Props) {
  ...
  if (isLocalhost(host) && slug === '222152') {
    ...
    return <EventProfilePage event={mockEvent} pathSlug={slug} />
  }
  ...
  return <EventProfilePage event={event} pathSlug={slug} />
}
