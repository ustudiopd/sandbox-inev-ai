...
export default function EditNotePage() {
  ...
  useEffect(() => {
    const loadNote = async () => {
      try {
        ...
        alert(error.message || '노트를 불러올 수 없습니다.')
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      router.push(`/client/${clientId}/notes/${noteId}`)
    } catch (error: any) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-16">
      <div className="max-w-4xl mx-auto px-4 py-8">
        {/* 헤더 */}
        <div className="mb-6">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">노트 수정</h1>
