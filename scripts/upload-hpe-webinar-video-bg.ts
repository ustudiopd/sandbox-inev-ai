...
async function uploadHPEWebinarVideoBg() {
  try {
    const admin = createAdminSupabase()

    const imagePath = join(process.cwd(), 'img', 'hpe', 'webinar_video_bg.png')
    ...
    const filePath = 'hpe/webinar_video_bg.png'
