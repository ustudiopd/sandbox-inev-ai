...
async function upload0312Persons567() {
  try {
    const admin = createAdminSupabase()
    const bucketName = 'webinar-thumbnails'
    
    const images = [
      { file: '0312_person_5.png', path: 'wert/0312_person_5.png' },
      { file: '0312_person_6.png', path: 'wert/0312_person_6.png' },
      { file: '0312_person_7.png', path: 'wert/0312_person_7.png' },
    ]
