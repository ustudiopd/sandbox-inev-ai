...
async function uploadEdmHeader1600_0126() {
  try {
    const admin = createAdminSupabase()
    const imagePath = join(process.cwd(), 'img', 'edm_header_1600_0126.jpg')
    ...
    const filePath = 'edm_header_1600_0126.jpg'
