...
async function uploadHPEWebinarHomeBg() {
  try {
    const admin = createAdminSupabase()

    const imagePath = join(process.cwd(), 'img', 'hpe', 'webinar_home_bg1.png')
    ...
    const filePath = 'hpe/webinar_home_bg1.png'
