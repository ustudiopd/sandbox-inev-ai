/**
 * 149405 웨비나의 등록 페이지 제거 스크립트
 * /149405 등록 캠페인을 삭제하고 웨비나의 registration_campaign_id를 제거합니다
 * 사용법: npx tsx scripts/remove-149405-registration.ts
 */
...
async function remove149405Registration() {
  try {
    ...
    if (!webinar) {
      console.error(`❌ 149405 웨비나를 찾을 수 없습니다`)
      process.exit(1)
    }
    ...
    console.log('\n✅ 작업 완료!')
    console.log(`   - 149405 웨비나의 등록 페이지가 제거되었습니다`)
