...
comment on function public.update_session_heartbeat is '세션 heartbeat 업데이트 (SELECT 제거, 조건부 UPDATE 1번으로 최적화). Δt cap 360초 적용';
...
comment on function public.check_heartbeat_throttle is '서버측 heartbeat throttle 체크. 최소 갱신 간격 이내면 false 반환';
